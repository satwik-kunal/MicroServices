...
public class QuizController {
    ...
    public ResponseEntity<String> getResult(@PathVariable int id, @RequestBody List<QuestionResponse> questionResponse){
        return quizService.getQuizResult(id,questionResponse);
    }
}
